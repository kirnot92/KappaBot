...
class DiscordBot
{
    ...
    {
        var createdTime = container.createdTimestamp;
        ...
        var newMsg = await channel.send(result.Message, result.Options) as MessageContainer;
        newMsg.edit("["+ (newMsg.createdTimestamp - createdTime) +"ms]:" + result.Message);
    }
}
